...
![baseline-pairplot.png](https://raw.githubusercontent.com/harrisonized/predicting-popularity-of-rock-climbs-regression/master/figures/bishop/eda/baseline-pairplot.png?raw=true)
...
![predicted-vs-observed.png](https://raw.githubusercontent.com/harrisonized/predicting-popularity-of-rock-climbs-regression/master/figures/bishop/linear/predicted-vs-observed.png?raw=true)
...
![mae-vs-alpha.png](https://github.com/harrisonized/predicting-popularity-of-rock-climbs-regression/blob/master/figures/bishop/ridge/mae-vs-alpha.png?raw=true)

Let's see how well this new model fits the data.

![predicted-vs-observed.png](https://github.com/harrisonized/predicting-popularity-of-rock-climbs-regression/blob/master/figures/bishop/ridge/predicted-vs-observed.png?raw=true)
...
![weights-vs-alpha.png](https://github.com/harrisonized/predicting-popularity-of-rock-climbs-regression/blob/master/figures/bishop/lasso/weights-vs-alpha.png?raw=true)
...
![mae-vs-alpha.png](https://github.com/harrisonized/predicting-popularity-of-rock-climbs-regression/blob/master/figures/bishop/lasso/mae-vs-alpha.png?raw=true)

Finally, let's see how well Lasso performs on the data.

![predicted-vs-observed.png](https://github.com/harrisonized/predicting-popularity-of-rock-climbs-regression/blob/master/figures/bishop/lasso/predicted-vs-observed.png?raw=true)
...
![predicted-vs-observed.png](https://github.com/harrisonized/predicting-popularity-of-rock-climbs-regression/blob/master/figures/bishop/poisson/predicted-vs-observed.png?raw=true)
...
![ratio-optimization.png](https://github.com/harrisonized/predicting-popularity-of-rock-climbs-regression/blob/master/figures/bishop/ensemble/ratio-optimization.png?raw=true)
